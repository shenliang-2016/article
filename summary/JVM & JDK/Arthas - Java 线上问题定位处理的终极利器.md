...
![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk0ibgWU6OJriav8icJQqvvbgl6lRd51Y3uLR8LFn6Qxdjtq10VrmvUPkswQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

在出现 **Arthas** Logo 之后就可以使用命令进行问题诊断了。下面会详细介绍。

![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk0x5U0T0Wica2zd5bcqLquFZohAX6N4OwSG8pozWeuiaZd0uEmnDUScVdg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk0x3cevPA26qz3asbpMqHqoyYzjsuyicd58Gmd1R7QolWqPpF0DoupnUQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk0KicBjSplBMVA9SGDVYAMy6gxSAVonewUniaMr3VHkvmjROA9Hdw1ia9cg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk0dO1gWjKSywskNaK9XPiaPpW7fznianUXaNKcvdDaHIicPMpIXO2SbdATw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

使用命令 **thread 12** 查看 CPU 消耗较高的 12 号线程信息，可以看到 CPU 使用较高的方法和行数（这里的行数可能和上面代码里的行数有区别，因为上面的代码在我写文章时候重新排过版了）。

![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk0mGxJHeQgniceniaLFuCkZ9CxGgtyuibeLLNu7ibar5ibJOZycNCJOPohDtA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

上面是先通过观察总体的线程信息，然后查看具体的线程运行情况。如果只是为了寻找 CPU 使用较高的线程，可以直接使用命令 **thread -n [显示的线程个数]** ，就可以排列出 CPU 使用率 **Top N** 的线程。

![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk0rGicUV7X5U4PzBCYcKnqicQibIVxz5dPwusxiaeYibqWaA7vaZaNRpZ9iaSA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

定位到的 CPU 使用最高的方法。

![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk0cvDOE3KmcNR2YKrkOibQ4GzDndqha1ro8FaxL2ejyJb8o7rzPibOZ6Jg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk0p6GibOereCO5ibo56lAqx1iccbBcv3WeHbbSQOuu1G1ZhKRqICGsIGqGw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

可以看到线程池有 **WAITING** 的线程。

![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk0W5Nqhv8zw64a9smXc3Wlm7t0AUqIWwoALSzBUso2AhgIXu4NGI4ZhQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk0q9npNaEygNXEoH4sbHN0ShBEjKH51fibIS8Gcc9ZalV3HmhNrcVPsPQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk063MqNibxicef06KOqkGOlal4JTgxX8PKDmiatBmZASx7UPAibXa6hnIlFg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk07laFCia8zwEWU7zuCexqLqzhVjTOxxa4e5OINcC1ltpibJcEIBYUUcCw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk0ianJS2UUZXOdY1RUJCg5ZynFzQAvjqEPkJpYF24DdIuSuoE92EsNmxw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk09sNbjjY4leMRqWq4SicxicqGp7cyk8Ko2o1DnyKh1eiabsIpVgWPd1xiag/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk0qOSdJrQgicMvjiarMaFibK9dWicAHHwYicBYQgvbWBStW4DLfQsehibRkzsQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk0qGZ2jVWTCtiaKAKUCYUEtDhUsicUhpBV1b5iajY4q8f5icHfhYzAds2snA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk055Q8kywo1jiaB0ZLtAEGnepgcYZMGZzxz6Kcibpia3gdBoWj5hBd6OW5w/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk049PGxB84ejPk8RKdANJbhCuvfnt0b8aLCRVpdDhf8gEyy3AZjQoWNA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

可以看到记录中 INDEX=1001 的记录的 IS-EXP = true ，说明这次调用出现异常。

查看记录的方法调用信息：tt -l

![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk06vqkO1CsqHOt8xibGHf0INfbwr331vWn4aGASybUOJFF0g50WQ5TXzg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

查看调用记录的详细信息（-i 指定 INDEX）：tt -i 1001

![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk0icbdTicW3nxoicq2ZXibTLhVd7UBiaLjW7ZL8qfMf4nLsmxjMR6Rskn0npQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/4lfok2icUkibT9l85hEmhL1xibM99SwOAk00IQGgtHmOHH8rWDKFhRMkic4GMWvJI9QJMKibT9dV840q0vWNPFQjaVg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
