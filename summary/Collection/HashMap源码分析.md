# HashMap 源码详细分析(JDK1.8)
 ...
 [2018-01-18](http://www.tianxiaobo.com/2018/01/18/HashMap-源码详细分析-JDK1-8/)  [Java基础](http://www.tianxiaobo.com/categories/foundation-of-java/)►[集合框架](http://www.tianxiaobo.com/categories/foundation-of-java/collection/)  [HashMap](http://www.tianxiaobo.com/tags/HashMap/), [Java](http://www.tianxiaobo.com/tags/Java/), [集合框架](http://www.tianxiaobo.com/tags/集合框架/)  5367  [评论](http://www.tianxiaobo.com/2018/01/18/HashMap-源码详细分析-JDK1-8/#comments) 字数统计: 11,517(字) 阅读时长: 46(分)
...
[![img](https://blog-pictures.oss-cn-shanghai.aliyuncs.com/15161231547335.jpg)](http://www.coolblog.xyz/)
...
本篇文章所分析的源码版本为 JDK 1.8。与 JDK 1.7 相比，JDK 1.8 对 HashMap 进行了一些优化。比如引入红黑树解决过长链表效率低的问题。重写 resize 方法，移除了 alternative hashing 相关方法，避免重新计算键的 hash 等。不过本篇文章并不打算对这些优化进行分析，本文仅会分析 HashMap 常用的方法及一些重要属性和相关方法。如果大家对红黑树感兴趣，可以阅读我的另一篇文章 - [红黑树详细分析](http://www.tianxiaobo.com/2018/01/18/HashMap-源码详细分析-JDK1-8/)。
...
[![img](https://blog-pictures.oss-cn-shanghai.aliyuncs.com/15159249414047.jpg)](http://www.coolblog.xyz/)
...
[![img](https://blog-pictures.oss-cn-shanghai.aliyuncs.com/15159947838577.jpg)](http://www.coolblog.xyz/)
...
[![img](https://blog-pictures.oss-cn-shanghai.aliyuncs.com/15160192933678.jpg)](http://www.coolblog.xyz/)
...
[![img](https://blog-pictures.oss-cn-shanghai.aliyuncs.com/15160157281390.jpg)](http://www.coolblog.xyz/)
...
[![img](https://blog-pictures.oss-cn-shanghai.aliyuncs.com/15160167712865.jpg)](http://www.coolblog.xyz/)
...
遍历结果如下：
[![img](https://blog-pictures.oss-cn-shanghai.aliyuncs.com/15160172288975.jpg)](http://www.coolblog.xyz/)
...
[![img](https://blog-pictures.oss-cn-shanghai.aliyuncs.com/15160915272993.jpg)](http://www.coolblog.xyz/)
...
[![img](https://blog-pictures.oss-cn-shanghai.aliyuncs.com/15160962033713.jpg)](http://www.coolblog.xyz/)

上图中，桶数组大小 n = 16，hash1 与 hash2 不相等。但因为只有后4位参与求余，所以结果相等。当桶数组扩容后，n 由16变成了32，对上面的 hash 值重新进行映射：

[![img](https://blog-pictures.oss-cn-shanghai.aliyuncs.com/15160965715169.jpg)](http://www.coolblog.xyz/)

扩容后，参与模运算的位数由4位变为了5位。由于两个 hash 第5位的值是不一样，所以两个 hash 算出的结果也不一样。上面的计算过程并不难理解，继续往下分析。

[![img](https://blog-pictures.oss-cn-shanghai.aliyuncs.com/15162009417224.jpg)](http://www.coolblog.xyz/)

假设我们上图的桶数组进行扩容，扩容后容量 n = 16，重新映射过程如下:

依次遍历链表，并计算节点 `hash & oldCap` 的值。如下图所示

![img](https://blog-pictures.oss-cn-shanghai.aliyuncs.com/15336456183498.jpg)
...
[![img](https://blog-pictures.oss-cn-shanghai.aliyuncs.com/15161040950151.jpg)](http://www.coolblog.xyz/)

最后再将这两条链接存放到相应的桶中，完成扩容。如下图：

[![img](https://blog-pictures.oss-cn-shanghai.aliyuncs.com/15162010230589.jpg)](http://www.coolblog.xyz/)
...
[![img](https://blog-pictures.oss-cn-shanghai.aliyuncs.com/15162026592538.jpg)](http://www.coolblog.xyz/)
...
[![img](https://blog-pictures.oss-cn-shanghai.aliyuncs.com/15161226696106.jpg)](http://www.coolblog.xyz/)
...
[![img](https://blog-pictures.oss-cn-shanghai.aliyuncs.com/15161648473103.jpg)](http://www.coolblog.xyz/)
...
> - **本文链接：** https://www.tianxiaobo.com/2018/01/18/HashMap-源码详细分析-JDK1-8/
