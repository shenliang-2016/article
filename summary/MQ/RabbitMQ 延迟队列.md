# [**【RabbitMQ】一文带你搞定RabbitMQ延迟队列**](https://www.imooc.com/article/290030)

2019.07.28 18:39 1129浏览
...
花了一个周末的时间完成了这篇文章，文中所有的代码都上传到了github，https://github.com/MFrank2016/delayed-queue-demo如有需要可以自行查阅，希望能对你有帮助，如果有错误的地方，欢迎指正。