# [前言](https://snailclimb.gitee.io/javaguide/#/docs/system-design/framework/spring/SpringBean?id=前言)
...
# [一 bean的作用域](https://snailclimb.gitee.io/javaguide/#/docs/system-design/framework/spring/SpringBean?id=一-bean的作用域)
...
### [2. prototype——每次请求都会创建一个新的 bean 实例](https://snailclimb.gitee.io/javaguide/#/docs/system-design/framework/spring/SpringBean?id=_2-prototype每次请求都会创建一个新的-bean-实例)
...
### [3. request——每一次HTTP请求都会产生一个新的bean，该bean仅在当前HTTP request内有效](https://snailclimb.gitee.io/javaguide/#/docs/system-design/framework/spring/SpringBean?id=_3-request每一次http请求都会产生一个新的bean，该bean仅在当前http-request内有效)
...
### [4. session——每一次HTTP请求都会产生一个新的 bean，该bean仅在当前 HTTP session 内有效](https://snailclimb.gitee.io/javaguide/#/docs/system-design/framework/spring/SpringBean?id=_4-session每一次http请求都会产生一个新的-bean，该bean仅在当前-http-session-内有效)
...
### [5. globalSession](https://snailclimb.gitee.io/javaguide/#/docs/system-design/framework/spring/SpringBean?id=_5-globalsession)
...
# [二 bean的生命周期](https://snailclimb.gitee.io/javaguide/#/docs/system-design/framework/spring/SpringBean?id=二-bean的生命周期)
...
### [initialization 和 destroy](https://snailclimb.gitee.io/javaguide/#/docs/system-design/framework/spring/SpringBean?id=initialization-和-destroy)
...
### [实现*Aware接口 在Bean中使用Spring框架的一些对象](https://snailclimb.gitee.io/javaguide/#/docs/system-design/framework/spring/SpringBean?id=实现aware接口-在bean中使用spring框架的一些对象)
...
### [BeanPostProcessor](https://snailclimb.gitee.io/javaguide/#/docs/system-design/framework/spring/SpringBean?id=beanpostprocessor)
...
### [总结](https://snailclimb.gitee.io/javaguide/#/docs/system-design/framework/spring/SpringBean?id=总结)
...
用图表示一下(图来源:[http://www.jianshu.com/p/d00539babca5)：](http://www.jianshu.com/p/d00539babca5)：)
...
### [单例管理的对象](https://snailclimb.gitee.io/javaguide/#/docs/system-design/framework/spring/SpringBean?id=单例管理的对象)
...
### [非单例管理的对象](https://snailclimb.gitee.io/javaguide/#/docs/system-design/framework/spring/SpringBean?id=非单例管理的对象)
...
# [三 说明](https://snailclimb.gitee.io/javaguide/#/docs/system-design/framework/spring/SpringBean?id=三-说明)
