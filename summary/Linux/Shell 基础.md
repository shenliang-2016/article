# [Shell 编程入门](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=shell-编程入门)

## [走进 Shell 编程的大门](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=走进-shell-编程的大门)

### [为什么要学Shell？](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=为什么要学shell？)
...
### [什么是 Shell？](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=什么是-shell？)

简单来说“Shell编程就是对一堆Linux命令的逻辑化处理”。

W3Cschool 上的一篇文章是这样介绍 Shell的，如下图所示。 ![什么是 Shell？](http://my-blog-to-use.oss-cn-beijing.aliyuncs.com/18-11-26/19456505.jpg)

### [Shell 编程的 Hello World](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=shell-编程的-hello-world)
...
## [Shell 变量](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=shell-变量)

### [Shell 编程中的变量介绍](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=shell-编程中的变量介绍)
...
### [Shell 字符串入门](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=shell-字符串入门)
...
### [Shell 字符串常见操作](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=shell-字符串常见操作)
...
### [Shell 数组](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=shell-数组)
...
## [Shell 基本运算符](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=shell-基本运算符)
...
### [算数运算符](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=算数运算符)
...
### [关系运算符](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=关系运算符)
...
### [逻辑运算符](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=逻辑运算符)
...
### [布尔运算符](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=布尔运算符)

![布尔运算符](http://my-blog-to-use.oss-cn-beijing.aliyuncs.com/18-11-22/93961425.jpg)

这里就不做演示了，应该挺简单的。

### [字符串运算符](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=字符串运算符)
...
### [文件相关运算符](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=文件相关运算符)
...
## [shell流程控制](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=shell流程控制)

### [if 条件语句](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=if-条件语句)
...
### [for 循环语句](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=for-循环语句)
...
### [while 语句](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=while-语句)
...
## [shell 函数](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=shell-函数)

### [不带参数没有返回值的函数](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=不带参数没有返回值的函数)
...
### [有返回值的函数](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=有返回值的函数)
...
### [带参数的函数](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/Shell?id=带参数的函数)
