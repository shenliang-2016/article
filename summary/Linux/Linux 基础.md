## [一 从认识操作系统开始](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/后端程序员必备的Linux基础知识?id=一-从认识操作系统开始)

### [1.1 操作系统简介](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/后端程序员必备的Linux基础知识?id=_11-操作系统简介)
...
### [1.2 操作系统简单分类](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/后端程序员必备的Linux基础知识?id=_12-操作系统简单分类)
...
## [二 初探Linux](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/后端程序员必备的Linux基础知识?id=二-初探linux)

### [2.1 Linux简介](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/后端程序员必备的Linux基础知识?id=_21-linux简介)
...
### [2.2 Linux诞生简介](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/后端程序员必备的Linux基础知识?id=_22-linux诞生简介)
...
### [2.3 Linux的分类](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/后端程序员必备的Linux基础知识?id=_23-linux的分类)
...
## [三 Linux文件系统概览](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/后端程序员必备的Linux基础知识?id=三-linux文件系统概览)

### [3.1 Linux文件系统简介](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/后端程序员必备的Linux基础知识?id=_31-linux文件系统简介)

**在Linux操作系统中，所有被操作系统管理的资源，例如网络接口卡、磁盘驱动器、打印机、输入输出设备、普通文件或是目录都被看作是一个文件。**

也就是说在LINUX系统中有一个重要的概念：**一切都是文件**。其实这是UNIX哲学的一个体现，而Linux是重写UNIX而来，所以这个概念也就传承了下来。在UNIX系统中，把一切资源都看作是文件，包括硬件设备。UNIX系统把每个硬件都看成是一个文件，通常称为设备文件，这样用户就可以用读写文件的方式实现对硬件的访问。

### [3.2 文件类型与目录结构](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/后端程序员必备的Linux基础知识?id=_32-文件类型与目录结构)
...
## [四 Linux基本命令](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/后端程序员必备的Linux基础知识?id=四-linux基本命令)

下面只是给出了一些比较常用的命令。推荐一个Linux命令快查网站，非常不错，大家如果遗忘某些命令或者对某些命令不理解都可以在这里得到解决。

Linux命令大全：[http://man.linuxde.net/](http://man.linuxde.net/)

### [4.1 目录切换命令](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/后端程序员必备的Linux基础知识?id=_41-目录切换命令)
...
### [4.2 目录的操作命令(增删改查)](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/后端程序员必备的Linux基础知识?id=_42-目录的操作命令增删改查)
...
### [4.3 文件的操作命令(增删改查)](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/后端程序员必备的Linux基础知识?id=_43-文件的操作命令增删改查)
...
### [4.4 压缩文件的操作命令](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/后端程序员必备的Linux基础知识?id=_44-压缩文件的操作命令)
...
### [4.5 Linux的权限命令](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/后端程序员必备的Linux基础知识?id=_45-linux的权限命令)
...
### [4.6 Linux 用户管理](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/后端程序员必备的Linux基础知识?id=_46-linux-用户管理)
...
### [4.8 其他常用命令](https://snailclimb.gitee.io/javaguide/#/docs/operating-system/后端程序员必备的Linux基础知识?id=_48-其他常用命令)
