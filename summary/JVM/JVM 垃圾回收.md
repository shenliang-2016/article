...
通过以下方式运行： ![img](http://my-blog-to-use.oss-cn-beijing.aliyuncs.com/18-8-26/25178350.jpg)

添加的参数：`-XX:+PrintGCDetails` ![img](http://my-blog-to-use.oss-cn-beijing.aliyuncs.com/18-8-26/10317146.jpg)
